...
export class MemberServiceProxy {
     ...
     * @return OK
     */
    getPaginatedMembers(searchText: string | undefined, skip: number | undefined, take: number | undefined): Observable<MemberOutputDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Member/GetPaginatedMembers?";
        if (searchText === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPaginatedMembers(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPaginatedMembers(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<MemberOutputDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<MemberOutputDtoPagedResultDto>;
        }));
    }

    protected processGetPaginatedMembers(response: HttpResponseBase): Observable<MemberOutputDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MemberOutputDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    create(body: MemberEntryDto | undefined): Observable<void> {
...
export class MemberEntryDto implements IMemberEntryDto {
    name: string | undefined;
    designation: string | undefined;
    email: string | undefined;
    primaryContact: string | undefined;
    potoPath: string | undefined;
    address: string | undefined;
    secondaryContact: string | undefined;
    bloodGroup: string | undefined;

    constructor(data?: IMemberEntryDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.potoPath = _data["potoPath"];
            this.address = _data["address"];
            this.secondaryContact = _data["secondaryContact"];
            this.bloodGroup = _data["bloodGroup"];
        }
    }

    static fromJS(data: any): MemberEntryDto {
        data = typeof data === 'object' ? data : {};
        let result = new MemberEntryDto();
        result.init(data);
        return result;
    }
...
export interface IMemberEntryDto {
    name: string | undefined;
    designation: string | undefined;
    email: string | undefined;
    primaryContact: string | undefined;
...
export class MemberOutputDto implements IMemberOutputDto {
    name: string | undefined;
    designation: string | undefined;
    email: string | undefined;
    primaryContact: string | undefined;
    ...
    constructor(data?: IMemberOutputDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MemberOutputDto {
        data = typeof data === 'object' ? data : {};
        let result = new MemberOutputDto();
        result.init(data);
        return result;
    }
...
export interface IMemberOutputDto {
    name: string | undefined;
    designation: string | undefined;
    email: string | undefined;
    primaryContact: string | undefined;
...
export class MemberOutputDtoPagedResultDto implements IMemberOutputDtoPagedResultDto {
    items: MemberOutputDto[] | undefined;
    totalCount: number;

    constructor(data?: IMemberOutputDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(MemberOutputDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): MemberOutputDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new MemberOutputDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): MemberOutputDtoPagedResultDto {
        const json = this.toJSON();
        let result = new MemberOutputDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IMemberOutputDtoPagedResultDto {
    items: MemberOutputDto[] | undefined;
    totalCount: number;
}

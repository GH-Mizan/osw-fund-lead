...
public abstract class OSWWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static OSWWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(OSWWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<OSWDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<OSWDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<OSWDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<OSWDbContext, Task<T>> func)
    {
        T result;
